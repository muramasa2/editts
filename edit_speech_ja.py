...
if __name__ == "__main__":
    ...
    start_frame = frame_series[
        math.floor(pos[start_idx + 1] / 200) - 5
    ]  # Sos記号の&^の分ずらす, hop sizeで切ったサンプル数に一番近いフレームを探す
    end_frame = frame_series[math.floor(pos[end_idx + 1] / 200) - 12]
    ...
    with torch.no_grad():
        ...
        sequence, emphases = ja_text_to_sequence_for_editts(
